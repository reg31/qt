...
void Generator::generateCode()
{
    ...
    QByteArray metaSuffix;
    if (cdef->hasQNamespace) {
        metaSuffix = '_' + qualifiedClassNameIdentifier;
        const char *n = metaSuffix.constData();
    ...
    fprintf(out, "    qt_staticMetaObjectStaticContent%s.stringdata,\n"
            ...
            metaSuffix.constData(), metaSuffix.constData());
    ...
    fprintf(out, "\nvoid *%s::qt_metacast(const char *_clname)\n{\n"
            ...
            cdef->qualified.constData(), metaSuffix.constData());
