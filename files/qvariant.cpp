...
#endif
QVariantList QVariant::toList() const { return qvariant_cast<QVariantList>(*this); }
QVariantMap QVariant::toMap() const { return qvariant_cast<QVariantMap>(*this); }
QVariantHash QVariant::toHash() const { return qvariant_cast<QVariantHash>(*this); }
